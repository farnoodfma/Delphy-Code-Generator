...
double CParser::parserPrimaryExpression()
{
    ...
    case ETokenType::MINUS:
        return -parserPrimaryExpression();
...
{
    double dResult =  parserPrimaryExpression();
    ...
    while(true){
        ...
        case ETokenType::MUL:
            dResult *= parserPrimaryExpression();
            break;

        case  ETokenType::DIV:{

            double dTemp = parserPrimaryExpression();
            if(dTemp != 0.0)
            {
              dResult /= dTemp;
              break;
